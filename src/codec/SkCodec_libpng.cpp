...
// FIXME: Is SkColorTable the right storage? It claims to store SkPMColors,
...
SkColorTable* decode_palette(png_structp png_ptr, png_infop info_ptr,
    ...
    */
    ...
    // FIXME: Not necessarily SkPMColors.
    ...
    if (numPalette < 256) {
        // FIXME: This comes from the old code, but does not look right.
        *colorPtr = colorPtr[-1];
    }
...
SkCodec* SkPngCodec::NewFromStream(SkStream* stream) {
    ...
    // FIXME: Should we move these later on? Probably.
    ...
    // FIXME: Is this necessary if we want to stick with gray? (same above?)
...
SkCodec::Result SkPngCodec::onGetPixels(const SkImageInfo& requestedInfo, void* dst,
    ...
    // FIXME: Need to rewind, if necessary...
